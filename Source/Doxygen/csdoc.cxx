...
//TODO {@link} {@linkplain} {@docRoot}, and other useful doxy commands that are not a csdoc tag

// define static tables, they are filled in CSDocConverter's constructor
std::map<std::string, std::pair<CSDocConverter::tagHandler, std::string> > CSDocConverter::tagHandlers;

using std::string;
using std::list;
using std::vector;

void CSDocConverter::fillStaticTables() {
  ...
  tagHandlers["a"] = make_pair(&CSDocConverter::handleTagHtml, "i");
  tagHandlers["arg"] = make_pair(&CSDocConverter::handleTagHtml, "li");
  tagHandlers["b"] = make_pair(&CSDocConverter::handleTagHtml, "b");
  tagHandlers["c"] = make_pair(&CSDocConverter::handleTagHtml, "code");
  tagHandlers["cite"] = make_pair(&CSDocConverter::handleTagHtml, "i");
  tagHandlers["e"] = make_pair(&CSDocConverter::handleTagHtml, "i");
  tagHandlers["em"] = make_pair(&CSDocConverter::handleTagHtml, "i");
  tagHandlers["li"] = make_pair(&CSDocConverter::handleTagHtml, "li");
  tagHandlers["p"] = make_pair(&CSDocConverter::handleTagHtml, "code");
  // these commands insert just a single char, some of them need to be escaped
  tagHandlers["$"] = make_pair(&CSDocConverter::handleTagChar, "");
  tagHandlers["@"] = make_pair(&CSDocConverter::handleTagChar, "");
  tagHandlers["\\"] = make_pair(&CSDocConverter::handleTagChar, "");
  tagHandlers["<"] = make_pair(&CSDocConverter::handleTagChar, "&lt;");
  tagHandlers[">"] = make_pair(&CSDocConverter::handleTagChar, "&gt;");
  ...
  tagHandlers["attention"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["anchor"] = make_pair(&CSDocConverter::handleTagAnchor, "");
  tagHandlers["brief"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["bug"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["date"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["details"] = make_pair(&CSDocConverter::handleParagraph, "");
  // this command is inserts text accumulated after cmd htmlonly -
  // see DoxygenParser - CMD_HTML_ONLY.
  tagHandlers["htmlonly"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["invariant"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["latexonly"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["manonly"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["partofdescription"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["rtfonly"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["short"] = make_pair(&CSDocConverter::handleParagraph, "");
  tagHandlers["xmlonly"] = make_pair(&CSDocConverter::handleParagraph, "");
  // these commands are kept as-is, they are supported by CSDoc
  tagHandlers["author"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["authors"] = make_pair(&CSDocConverter::handleTagSame, "author");
  tagHandlers["deprecated"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["exception"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["package"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["param"] = make_pair(&CSDocConverter::handleTagParam, "");
  tagHandlers["tparam"] = make_pair(&CSDocConverter::handleTagParam, "");
  tagHandlers["ref"] = make_pair(&CSDocConverter::handleTagRef, "");
  tagHandlers["result"] = make_pair(&CSDocConverter::handleTagSame, "return");
  tagHandlers["return"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["returns"] = make_pair(&CSDocConverter::handleTagSame, "return");
  //tagHandlers["see"] = make_pair(&CSDocConverter::handleTagSame, "");
  //tagHandlers["sa"] = make_pair(&CSDocConverter::handleTagSame, "see");
  tagHandlers["since"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["throws"] = make_pair(&CSDocConverter::handleTagSame, "");
  tagHandlers["throw"] = make_pair(&CSDocConverter::handleTagSame, "throws");
  tagHandlers["version"] = make_pair(&CSDocConverter::handleTagSame, "");
  // these commands have special handlers
  tagHandlers["code"] = make_pair(&CSDocConverter::handleTagExtended, "code");
  tagHandlers["cond"] = make_pair(&CSDocConverter::handleTagMessage, "Conditional comment: ");
  tagHandlers["copyright"] = make_pair(&CSDocConverter::handleTagMessage, "Copyright: ");
  tagHandlers["else"] = make_pair(&CSDocConverter::handleTagIf, "Else: ");
  tagHandlers["elseif"] = make_pair(&CSDocConverter::handleTagIf, "Else if: ");
  tagHandlers["endcond"] = make_pair(&CSDocConverter::handleTagMessage, "End of conditional comment.");
  // space in second arg prevents csdoc to treat '@ example' as command. File name of
  // example is still informative to user.
  tagHandlers["example"] = make_pair(&CSDocConverter::handleTagSame, " example");
  tagHandlers["if"] = make_pair(&CSDocConverter::handleTagIf, "If: ");
  tagHandlers["ifnot"] = make_pair(&CSDocConverter::handleTagIf, "If not: ");
  tagHandlers["image"] = make_pair(&CSDocConverter::handleTagImage, "");
  tagHandlers["link"] = make_pair(&CSDocConverter::handleTagLink, "");
  tagHandlers["see"] = make_pair(&CSDocConverter::handleTagSee, "");
  tagHandlers["sa"] = make_pair(&CSDocConverter::handleTagSee, "");
  tagHandlers["note"] = make_pair(&CSDocConverter::handleTagMessage, "Note: ");
  tagHandlers["overload"] = make_pair(&CSDocConverter::handleTagMessage,
                                      "This is an overloaded member function, provided for"
                                      " convenience. It differs from the above function only in what" " argument(s) it accepts.");
  tagHandlers["par"] = make_pair(&CSDocConverter::handleTagPar, "");
  tagHandlers["remark"] = make_pair(&CSDocConverter::handleTagMessage, "Remarks: ");
  tagHandlers["remarks"] = make_pair(&CSDocConverter::handleTagMessage, "Remarks: ");
  tagHandlers["todo"] = make_pair(&CSDocConverter::handleTagMessage, "TODO: ");
  tagHandlers["verbatim"] = make_pair(&CSDocConverter::handleTagExtended, "literal");

  // \f commands output literal Latex formula, which is still better than nothing.
  tagHandlers["f$"] = make_pair(&CSDocConverter::handleTagVerbatim, "");
  tagHandlers["f["] = make_pair(&CSDocConverter::handleTagVerbatim, "");
  tagHandlers["f{"] = make_pair(&CSDocConverter::handleTagVerbatim, "");

  tagHandlers["warning"] = make_pair(&CSDocConverter::handleTagMessage, "Warning: ");
  // this command just prints it's contents
  // (it is internal command of swig's parser, contains plain text)
  tagHandlers["plainstd::string"] = make_pair(&CSDocConverter::handlePlainString, "");
  tagHandlers["plainstd::endl"] = make_pair(&CSDocConverter::handleNewLine, "");
  tagHandlers["n"] = make_pair(&CSDocConverter::handleNewLine, "");

  // HTML tags
  tagHandlers["<a"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<a");
  tagHandlers["<b"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<b");
  tagHandlers["<blockquote"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<blockquote");
  tagHandlers["<body"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<body");
  tagHandlers["<br"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<br");
  tagHandlers["<center"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<center");
  tagHandlers["<caption"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<caption");
  tagHandlers["<code"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<code");
  tagHandlers["<dd"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<dd");
  tagHandlers["<dfn"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<dfn");
  tagHandlers["<div"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<div");
  tagHandlers["<dl"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<dl");
  tagHandlers["<dt"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<dt");
  tagHandlers["<em"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<em");
  tagHandlers["<form"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<form");
  tagHandlers["<hr"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<hr");
  tagHandlers["<h1"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<h1");
  tagHandlers["<h2"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<h2");
  tagHandlers["<h3"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<h3");
  tagHandlers["<i"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<i");
  tagHandlers["<input"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<input");
  tagHandlers["<img"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<img");
  tagHandlers["<li"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<li");
  tagHandlers["<meta"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<meta");
  tagHandlers["<multicol"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<multicol");
  tagHandlers["<ol"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<ol");
  tagHandlers["<p"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<p");
  tagHandlers["<pre"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<pre");
  tagHandlers["<small"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<small");
  tagHandlers["<span"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<span");
  tagHandlers["<strong"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<strong");
  tagHandlers["<sub"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<sub");
  tagHandlers["<sup"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<sup");
  tagHandlers["<table"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<table");
  tagHandlers["<td"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<td");
  tagHandlers["<th"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<th");
  tagHandlers["<tr"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<tr");
  tagHandlers["<tt"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<tt");
  tagHandlers["<kbd"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<kbd");
  tagHandlers["<ul"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<ul");
  tagHandlers["<var"] = make_pair(&CSDocConverter::handleDoxyHtmlTag, "<var");

  // HTML entities
  tagHandlers["&copy"] = make_pair(&CSDocConverter::handleHtmlEntity, "&copy");
  tagHandlers["&trade"] = make_pair(&CSDocConverter::handleHtmlEntity, "&trade");
  tagHandlers["&reg"] = make_pair(&CSDocConverter::handleHtmlEntity, "&reg");
  tagHandlers["&lt"] = make_pair(&CSDocConverter::handleHtmlEntity, "&lt");
  tagHandlers["&gt"] = make_pair(&CSDocConverter::handleHtmlEntity, "&gt");
  tagHandlers["&amp"] = make_pair(&CSDocConverter::handleHtmlEntity, "&amp");
  tagHandlers["&apos"] = make_pair(&CSDocConverter::handleHtmlEntity, "&apos");
  tagHandlers["&quot"] = make_pair(&CSDocConverter::handleHtmlEntity, "&quot");
  tagHandlers["&lsquo"] = make_pair(&CSDocConverter::handleHtmlEntity, "&lsquo");
  tagHandlers["&rsquo"] = make_pair(&CSDocConverter::handleHtmlEntity, "&rsquo");
  tagHandlers["&ldquo"] = make_pair(&CSDocConverter::handleHtmlEntity, "&ldquo");
  tagHandlers["&rdquo"] = make_pair(&CSDocConverter::handleHtmlEntity, "&rdquo");
  tagHandlers["&ndash"] = make_pair(&CSDocConverter::handleHtmlEntity, "&ndash");
  tagHandlers["&mdash"] = make_pair(&CSDocConverter::handleHtmlEntity, "&mdash");
  tagHandlers["&nbsp"] = make_pair(&CSDocConverter::handleHtmlEntity, "&nbsp");
  tagHandlers["&times"] = make_pair(&CSDocConverter::handleHtmlEntity, "&times");
  tagHandlers["&minus"] = make_pair(&CSDocConverter::handleHtmlEntity, "&minus");
  tagHandlers["&sdot"] = make_pair(&CSDocConverter::handleHtmlEntity, "&sdot");
  tagHandlers["&sim"] = make_pair(&CSDocConverter::handleHtmlEntity, "&sim");
  tagHandlers["&le"] = make_pair(&CSDocConverter::handleHtmlEntity, "&le");
  tagHandlers["&ge"] = make_pair(&CSDocConverter::handleHtmlEntity, "&ge");
  tagHandlers["&larr"] = make_pair(&CSDocConverter::handleHtmlEntity, "&larr");
  tagHandlers["&rarr"] = make_pair(&CSDocConverter::handleHtmlEntity, "&rarr");
}

CSDocConverter::CSDocConverter(int flags) :
 ...
 * better algorithm.
 */
std::string CSDocConverter::formatCommand(std::string unformattedLine, int indent) {
 ...
 */
bool CSDocConverter::paramExists(std::string param) {
...
std::string CSDocConverter::translateSubtree(DoxygenEntity &doxygenEntity) {
 ...
 */
void CSDocConverter::translateEntity(DoxygenEntity &tag, std::string &translatedComment) {
...
void CSDocConverter::handleTagAnchor(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  translatedComment += "<a id=\"" + translateSubtree(tag) + "\"></a>";
}


void CSDocConverter::handleTagHtml(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
...
void CSDocConverter::handleDoxyHtmlTag(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
...
void CSDocConverter::handleHtmlEntity(DoxygenEntity &, std::string &translatedComment, std::string &arg) {
  // html entities can be preserved for Java
  translatedComment += arg + ';';
}

void CSDocConverter::handleNewLine(DoxygenEntity &, std::string &translatedComment, std::string &) {
  // <br> tag is added, because otherwise to much text is joined
  // into same paragraph by csdoc. For example, doxy list:
  // - item one
  // - item two
...
// handles tags which are the same in Doxygen and csdoc.
void CSDocConverter::handleTagSame(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
  if (arg.size())
    tag.typeOfEntity = arg;
  translatedComment += formatCommand(std::string("@" + tag.typeOfEntity + " " + translateSubtree(tag)), 2);
}

void CSDocConverter::handleParagraph(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  translatedComment += formatCommand(translateSubtree(tag), 0);
}

void CSDocConverter::handlePlainString(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  translatedComment += tag.data;
  // if (tag.data.size() && tag.data[tag.data.size()-1] != ' ')
  //    translatedComment += " ";
}

void CSDocConverter::handleTagVerbatim(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
  translatedComment += arg + " ";
...
void CSDocConverter::handleTagExtended(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
  std::string dummy;
  translatedComment += "{@" + arg + " ";
...
void CSDocConverter::handleTagIf(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
  std::string dummy;
  translatedComment += arg;
...
void CSDocConverter::handleTagMessage(DoxygenEntity &tag, std::string &translatedComment, std::string &arg) {
  std::string dummy;
  translatedComment += formatCommand(arg, 0);
  handleParagraph(tag, translatedComment, dummy);
}

void CSDocConverter::handleTagImage(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
...
void CSDocConverter::handleTagPar(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  std::string dummy;
  translatedComment += "<p";
  if (tag.entityList.size()) {
...
void CSDocConverter::handleTagParam(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  std::string dummy;
...
void CSDocConverter::handleTagRef(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  std::string dummy;
  if (!tag.entityList.size())
    return;
...
string CSDocConverter::convertLink(string linkObject) {
...
void CSDocConverter::handleTagLink(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  std::string dummy;
  if (!tag.entityList.size())
    return;
...
void CSDocConverter::handleTagSee(DoxygenEntity &tag, std::string &translatedComment, std::string &) {
  std::string dummy;
  if (!tag.entityList.size())
    return;
 ...
 *
 */
int CSDocConverter::shiftEndlinesUpTree(DoxygenEntity &root, int level) {
...
String *CSDocConverter::makeDocumentation(Node *node) {
  ...
  if (m_flags & debug_translator) {
    ...
    std::cout << csdocString;
  }

  return NewString(csdocString.c_str());
}

void CSDocConverter::addError(int warningType, const std::string &message) {
